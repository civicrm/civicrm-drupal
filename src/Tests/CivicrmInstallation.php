...
class CivicrmInstallation extends CivicrmTestBase {
  public function testCleanInstall() {
    $this->assertTrue(file_exists(\Drupal\Core\DrupalKernel::getSitePath() . '/civicrm.settings.php'), "The civicrm.settings.php file was found in " .\Drupal\Core\DrupalKernel::getSitePath());
